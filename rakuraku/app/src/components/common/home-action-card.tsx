...
const iconStyles: Record<HomeActionColor, string> = {
...
export function HomeActionCard({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "flex h-[60px] w-[60px] items-center justify-center rounded-[14px] [&_svg]:h-[30px] [&_svg]:w-[30px]",
          iconStyles[color]
        )}
      >
        {icon}
